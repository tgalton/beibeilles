...
def test_create_sensor_device(mock_create: Mock) -> None:
...
def test_get_sensor_by_serial_passes_serial(
    ...
    assert mock_get.call_args.kwargs["serial_number"] == "ABC123"
...
def test_associate_hive_passes_parameters(
    ...
    assert mock_associate.call_args.kwargs["serial_number"] == "ABC123"

    assert mock_associate.call_args.kwargs["hive_id"] == 5
